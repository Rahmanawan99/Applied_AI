...
def draw_hud(frame, name, confidence, ear, attendance_marked):
    ...
    ear_bar_width = int(200 * (ear * 2)) # Scaled for visibility
...
def draw_charts(ear_hist, conf_hist):
    # Create a black image for charts
    ...
    # Draw EAR Chart (Blink Stability)
...
while True:
    ...
    # Liveness check always runs for stability charts
    ...
    if face is not None:
        ...
        if current_conf > 0.6 and blink_triggered:
            ...
            attendance_alert_timer = 30 # Show alert for 30 frames
